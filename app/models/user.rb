class User < ApplicationRecord
  ...
  validates :last_name, :first_name, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]/ }, allow_blank: true
  validates :ruby_last_name, :ruby_first_name, format: { with: /\A[ァ-ヶー－]+\z/ }, allow_blank: true
end
